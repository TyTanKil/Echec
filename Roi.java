...
public class Roi extends Piece {
	...
	public boolean peutSeDeplacer(int ligneArrivee, int colonneArrivee, Plateau plateau) {
		...
		if (colonneArrivee != colonne && ligneArrivee != ligne &&
		 ...
		 //Si la colonne d'arrivée est la même colonne de départ, on vérifie si le coup joué est un déplacement d'une case vers le haut ou vers le bas
		...
		if(colonneArrivee == colonne) {
		 ...
		 //Si la ligne d'arrivée est la même ligne de départ, on vérifie si le coup joué est un déplacement d'une case vers la gauche ou vers la droite
		...
		if(ligneArrivee == ligne) {
		 ...
		 //On vérifie l'équation 1 du Fou, si c'est true, on compare la ligne d'arrivée et la ligne de départ pour vérifier si on monte ou descend d'une case en diagonale
		...
		if(ligneArrivee - colonneArrivee == ligne - colonne) {
		 ...
		 //On vérifie l'équation 2 du Fou, si c'est true, on compare la ligne d'arrivée et la ligne de départ pour vérifier si on monte  ou descend d'une case en diagonale
