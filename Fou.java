public class Fou extends Piece {
	...
	public boolean peutSeDeplacer(int ligneArrivee, int colonneArrivee, Plateau plateau) {
		...
		if (pieceArrivee != null) {
		 ...
		 //Vérification si la case d'arrivée est bien sur la diagonale de la case de départ
		...
		/*
		 Vérification si c'est une diagonale montante ou descendante
		 Vérifiaction si la pièce souhaite aller vers le haut ou vers le bas en comparant la ligne d'arrivée est supérieur à 
		 la ligne de départ
		 Vérification à l'aide d'une boucle, si il y a une pièce entre la case d'arrivée et la case de départ sur la diagonale
